...
QWEN_IMAGE_MAX_LATEST = {
    "name": "QwenImageMax 图片生成",
    "type": "text2image",
    "post_endpoint": "/vendors/alibaba/v1/qwen-image-max/generation",
    "get_endpoint": "/vendors/alibaba/v1/qwen-image-max/generation/{task_id}",
    "result_key": "images",
    "params": {
        "prompt": {"type": "text", "required": True, "max_length": 2000, "label": "Prompt (图片描述)"},
        "negative_prompt": {"type": "text", "required": False, "max_length": 500, "label": "Negative Prompt (不希望出现的内容)"},
...
QWEN_IMAGE_EDIT_MAX = {
    "name": "QwenImageEditMax 图片编辑",
    "type": "image2image",
    "post_endpoint": "/vendors/alibaba/v1/qwen-image-edit-max/generation",
    "get_endpoint": "/vendors/alibaba/v1/qwen-image-edit-max/generation/{task_id}",
    "result_key": "images",
    "image_as_array": True,
    "multi_image": True,
    "max_images": 3,
...
MODELS = {
    ...
    "qwen_image_max_latest": QWEN_IMAGE_MAX_LATEST,
    "qwen_image_edit_plus": QWEN_IMAGE_EDIT_PLUS,
    "qwen_image_edit_max": QWEN_IMAGE_EDIT_MAX,
}
